...
($R_e$) until the 6th April 2020, after which these numbers remained low in all NHS
regions for a period of about two weeks (Figure \@ref(fig:estimates)). The lowest $r$ estimated over
...
lower $r$ (and $R_e$) after the 13th of April.
...
$R_e$ seem to have gradually increased, to a point where there was no longer any
...
with a lag of 16 days (Pearson's correlation = 0.9; 95% CI: 0.6 - 0.99). Figure 3 illustrates the
